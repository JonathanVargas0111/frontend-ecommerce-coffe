                    ...
                    !loading && result !== undefined && (
                        categories.map((category: CategoryType) => (
                                <Link
                                    ...
                                    className='relative max-w-xs mx-auto overflow-hidden bg-no-repeat bg-cover rounded-lg cursor-pointer'
                                >
                                    <img
                                    ...
                                    /> 
                                    <p className='absolute w-full py-2 text-lg font-bold text-center bottom-5 backdrop-blur-lg text-black'>
